...
if [ $py_only -ne 1 ];then
	...
	# # Specular points binary files
# 	echo $path_compiler -o "$path_spock_abso"/spec_dev ./src/find_specular_points.c -lm -w -I"$path_spice_abso" -I"$path_spice_abso"/include "$path_spice_abso"/lib/csupport.a "$path_spice_abso"/lib/cspice.a # change the path of the executable here 
	#$path_compiler -o "$path_spock_abso"/spec_asph ./src/find_specular_points_aspherical.c -lm -w -I"$path_spice_abso" -I"$path_spice_abso"/include "$path_spice_abso"/lib/csupport.a "$path_spice_abso"/lib/cspice.a # change the path of the executable here  	
   	#$path_compiler -o "$path_spock_abso"/spec_dev_debug ./src/find_specular_points.c -lm -w -I"$path_spice_abso" -I"$path_spice_abso"/include "$path_spice_abso"/lib/csupport.a "$path_spice_abso"/lib/cspice.a # change the path of the executable here  	
