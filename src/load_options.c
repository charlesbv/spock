...
// A bit before, we read main input file to figure out the path to spice (where leap second file, and other files are). Now we figure out the other SPICE kernels to load
  ...
  if ( strcmp(text_spice, "default") == 0 ){ // if 'default' chosen in section #SPICE. So that means that either the line below the path was empty or that the user put 'default' in this line
    ...
    strcpy(earth_binary_pck_path_temp, "earth_000101_191026_190804.bpc");// !!!!! used to be "earth_000101_191026_190804.bpc");
    strcat(earth_binary_pck_path, "earth_000101_191026_190804.bpc");// !!!!! used to be "earth_000101_191026_190804.bpc");
...
/*     strcpy(earth_binary_pck_path_temp, "earth_000101_191026_190804.bpc"); */
/*     strcat(earth_binary_pck_path, "earth_000101_191026_190804.bpc"); */
/*   }  */
