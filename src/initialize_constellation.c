...
/* 	v_print(CONSTELLATION->spacecraft[ii][eee].r_ecef2cg_ECEF,"uu"); */
	...
	CONSTELLATION->spacecraft[ii][eee].INTEGRATOR.density_mod = OPTIONS->density_mod; // density mod: factor to apply on density at position of satellite (calculated by NRLMSIS, gitm or from density file)
...
/* 				 CONSTELLATION->spacecraft[ii][0].r_ecef2cg_ECEF) ; */
	...
	CONSTELLATION->spacecraft[ii][0].INTEGRATOR.density_mod = OPTIONS->density_mod; // density mod: factor to apply on density at position of satellite (calculated by NRLMSIS, gitm or from density file)
