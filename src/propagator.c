...
//newstructure
  ...
  PARAMS->EARTH.GRAVITY.dradius_map = 22. ;//PARAMS->EARTH.GRAVITY.dlon_map * 100.;
  PARAMS->EARTH.GRAVITY. min_lat_map = -0.11;
  PARAMS->EARTH.GRAVITY.max_lat_map = 0.11;
  PARAMS->EARTH.GRAVITY.min_radius_map = PARAMS->EARTH.radius + 480;//200.;
  PARAMS->EARTH.GRAVITY.max_radius_map = PARAMS->EARTH.radius + 501;//40000.;
...
int gravity_map(GRAVITY_T  *Gravity, int degree,  int iProc){
  ...
  char text[200];
  strcpy(text, "");
  strcpy(filename_gravity_map, "grav_alt");
  ...
  strcat(filename_gravity_map, text);
  strcat(filename_gravity_map, ".txt");
  //printf("%s\n", filename_gravity_map);
  Gravity->file_gravity_map = fopen(filename_gravity_map, "w+");
  ...
  fprintf(Gravity->file_gravity_map, "// radius: %.1f to %1.f, step %1.f (%km)\n", min_radius, max_radius, dradius);
