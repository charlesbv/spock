...
date_start = date_obs_start
date_end = date_start + timedelta(seconds = nb_interval * interval_sec)
date_end_str = datetime.strftime(date_end, "%Y-%m-%dT%H:%M:%S")
date_start_str = datetime.strftime(date_start, "%Y-%m-%dT%H:%M:%S")
...
fig_save_name = 'rho_distance_ens_to_observations_' + main_input_filename_root.replace("txt", "noSolarPressure.pdf")
