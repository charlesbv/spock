...
# for FORCES section
gravity_order = 0 #!!!!!!!!change back to 4
...
if predict_spec == 1:
    ...
    os.system(path_mpirun + " -np 8 spec_dev_parallel " + main_input_filename + " -lon=0 -rot=0 -min >> " + log_filename)
    ...
    os.system(path_mpirun + " -np 8 storm_dev_parallel " + main_input_filename + " 0 >> " +  log_filename)
