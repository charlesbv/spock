...
nb_days_pred = 3 
path_hist_pred = '/home/cbv/solar_wind_prediction/f107_ap/swpc/predictions/3d/historical/'
...
for ipred in range(n_pred):
    ...
    file_pred = open("/home/cbv/solar_wind_prediction/f107_ap/swpc/predictions/3d/historical/" + filename_pred)
...
filename_f107_obs1 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/f107/f107_2016Q1.txt"
filename_f107_obs2 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/f107/f107_2016Q2.txt"
filename_f107_obs3 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/f107/f107_2016Q3.txt"
filename_f107_obs4 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/f107/f107_2016Q4.txt"
filename_f107_obs = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/f107/f107_2016Q1_concatenated_with_2016Q2_concatenated_with_2016Q3_concatenated_with_2016Q4.txt"
...
# # Ap observations
filename_ap_obs1 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/ap/ap_2016Q1.txt"
filename_ap_obs2 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/ap/ap_2016Q2.txt"
filename_ap_obs3 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/ap/ap_2016Q3.txt"
filename_ap_obs4 = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/ap/ap_2016Q4.txt"
filename_ap_obs = "/home/cbv/solar_wind_prediction/f107_ap/swpc/observations/ap/ap_2016Q1_concatenated_with_2016Q2_concatenated_with_2016Q3_concatenated_with_2016Q4.txt"
...
difference_pred_obs_array = np.zeros([new_nb_days_pred, n_pred])
for iforecast in range(1, new_nb_days_pred + 1):
    ...
    for ibin in range(nbins):
        f107_bin_pred_array[iforecast-1, ibin] = ( np.histogram(difference_pred_obs, bins = nbins, density = 1)[1][ibin+1] + np.histogram(difference_pred_obs, bins = nbins, density = 1)[1][ibin]  ) / 2.
    ax.hist(difference_pred_obs, bins = 50)
    percentage_in_f107_bin_pred_array[iforecast-1, :] = np.histogram(difference_pred_obs, bins = nbins, density = 1)[0] # if density is True, the result is the value of the probability density function at the bin, normalized such that the integral over the range is 1. Note that the sum of the histogram values will not be equal to 1 unless bins of unity width are chosen; it is not a probability mass function.
    for iquartile in range(nquartile):
        f107_quartile[iforecast-1, iquartile] = np.percentile(difference_pred_obs, quartile_array[iquartile])
    difference_pred_obs_array[iforecast-1, 0:n_pred-iforecast] = difference_pred_obs[0:n_pred-iforecast]
    
    print np.percentile(difference_pred_obs,75) - np.percentile(difference_pred_obs,25)
# GENERATE DISCTINCT COLORS
# fig,ax = plt.subplots()
# for ipred in range(n_pred-new_nb_days_pred):
#     ax.plot(difference_pred_obs_array[:, ipred])
...
for iforecast in range(1, new_nb_days_pred + 1):
    ...
    for ibin in range(nbins):
        ap_bin_pred_array[iforecast-1, ibin] = ( np.histogram(difference_pred_obs, bins = nbins, density = 1)[1][ibin+1] + np.histogram(difference_pred_obs, bins = nbins, density = 1)[1][ibin]  ) / 2.
    ax.hist(difference_pred_obs, bins = 50)
    percentage_in_ap_bin_pred_array[iforecast-1, :] = np.histogram(difference_pred_obs, bins = nbins, density = 1)[0] # if density is True, the result is the value of the probability density function at the bin, normalized such that the integral over the range is 1. Note that the sum of the histogram values will not be equal to 1 unless bins of unity width are chosen; it is not a probability mass function.
    for iquartile in range(nquartile):
        ap_quartile[iforecast-1, iquartile] = np.percentile(difference_pred_obs, quartile_array[iquartile])
    print np.percentile(difference_pred_obs,75) - np.percentile(difference_pred_obs,25)
# for iquartile in range(nquartile):
#     colorVal = scalarMap.to_rgba(values[iquartile])
