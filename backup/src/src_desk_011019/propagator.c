...
/* 	} */
  ...
  // time dependent
  //  double fac_density =  SC->INTEGRATOR.density_mod + SC->INTEGRATOR.density_mod_amp * sin(2*M_PI*(et-OPTIONS->et_initial_epoch)/SC->OE.period + SC->INTEGRATOR.density_mod_phase*2*M_PI) ; 
  ...
  // latitude dependdent: max of sine at perigee if INTEGRATOR.density_mod_phase = 0
  double fac_density = 1; 
