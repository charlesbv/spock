...
pickle_root = "oneplane"
lat_width = 5 # latitude width of the grid, in degrees
lon_width = 5 # longitude width of the grid, in degrees
# end of PARAMETERS TO SET UP BEFORE RUNNING THIS SCRIPT

width_cell_array = [0.01, 0.05, 0.1, 0.15, 0.20, 0.25] #!!!!!! should be [0.01, 0.05, 0.1, 0.15, 0.20, 0.25] # in degrees
...
lon_grid_center_array = np.arange(5, 360, 12)
...
pickle.dump(time_to_reach_coverage_average_over_lon, open( "/raid4/cbv/coverage_temporal_spatial_relation/pickle/" + pickle_root + "_time_to_reach_coverage_average_over_lon", "w"))
