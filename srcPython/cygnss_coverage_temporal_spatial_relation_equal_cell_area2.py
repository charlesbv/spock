...
#pickle_folder = "/nobackup/cbussy/coverage_temporal_spatial_relation/pickle_1212" # with or without the last '/' (doesnt matter). also the directory doesnt need to exist 
