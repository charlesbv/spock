...
run_list = ["all_nadir"] #  list of cygnss_coverage_temporal_spatial_relation.py runs to compare. !!!!! need to run cygnss_coverage_temporal_spatial_relation_equal_cell_area2.py for each of these runs first
