...
input_filename = 'spec_spock_2d_noIIF.txt'
...
exclude_revisit_dt = 1.25 # if two visits are within exclude_revisit_dt seconds, then count the two visits as one visit
lat_max = 35
lat_min = -35
