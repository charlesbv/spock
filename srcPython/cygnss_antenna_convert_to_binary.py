# This script takes as input the antenna in txt or agm format and convert it into a binary file in the format readable by tds-bop.exe (beacon software)
# INPUTS:
...
# 3- if fthe format of the input file is different than from 1- and 2-, adpat the script accordingly

# PARAMETERS TO SET UP BEFORE RUNNING THIS SCRIPT
filename_gain_in = '/Users/cbv/cspice/data/ant_1_port_ddmi_v1.agm'
