...
date_start_val_start = '2018-05-09T00:00:00'#'2018-03-20T00:00:00'#"2017-06-01T00:00:00"
dir_run_spock = '/Users/cbv/cygnss/valsift_roll'#'/Users/cbv/cygnss/sift_temp' # '.' # no slash
dir_run_spock_out = '/Users/cbv/cygnss/valsift_roll/spock_out' #'spock' # name of output folder, no slash
pitch_max = 2. # filter out when pitch is greater than this value (in magnitude)
roll_max = 40. # filter out when roll is greater than this value (in magnitude)
...
for idate in range(0,nb_date):# !!!!!!! should be: nb_date):
    ...
    date_stop_val = datetime.strftime(date_start_val_array[idate]+ timedelta(seconds = 0.0*24*3600+23*3600+59*60+59), "%Y-%m-%dT%H:%M:%S") #'2017-06-06T01:02:00'#'2017-06-03T00:45:00'#'2017-06-06T01:02:00'#'2017-06-02T00:56:00'#'2017-06-06T01:02:00'#'2017-06-02T00:43:00'  # !!!! shoul be + timedelta(seconds = 6*24*3600+23*3600+59*60+59), "%Y-%m-%dT%H:%M:%S")#"2017-08-20T06:00:00" # date to stop the validation
