...
def spock_main_input( 
    ...
    # SPACECRAFT section
    #print >> main_input_file, "#SPACECRAFT\n" + str(nb_sc) + "\n" + gps_tle + "\n" + str(mass) + "\n-1\n" + geometry_filename  + "\n" ### this what should be, not line below
    print >> main_input_file, "#SPACECRAFT\n" + str(nb_sc) + "\n" + gps_tle + "\n" + str(mass) + "\n-1\n" + geometry_filename  + "\n" 
    ...
    if type(tle_filename) == str:
        ...
        elif tle_filename[0] == 'collision_vcm':
            print >> main_input_file, tle_filename[1]    
            print >> main_input_file, tle_filename[2]    
            print >> main_input_file, tle_filename[3]    
        else:
            isc = 0
            while isc < nb_sc:
    ...
    if type(rho_mod) != list:
        ...
        if rho_mod[0] == 'msis_lat_depend':
            print >> main_input_file,  str(rho_mod[1]) + ' ' + str(rho_mod[2]) + ' ' + str(rho_mod[3]) 
        else:
