...
start_date_minus_one_week_date = datetime.strptime(start_date[0:10], "%Y-%m-%d") - timedelta(days = 7)
start_date_minus_one_week = datetime.strftime(start_date_minus_one_week_date, "%Y-%m-%d")
start_date_no_time = start_date_minus_one_week[0:10] # !!!!!!!!! that's the difference iwth spock_cygnss_spec_parallel: it uses TLEs one week old
...
## Set up parameters
if sgp4 == '1':
    main_input_filename = 'spock_spec_start_' + start_date.replace(":", "_") + '_end_' + end_date.replace(":", "_") + '_sgp4_using_one_week_old_tle.txt'
else:
    main_input_filename = 'spock_spec_start_' + start_date.replace(":", "_") + '_end_' + end_date.replace(":", "_") + '_classic_using_one_week_old_tle.txt'
# for TIME section
date_start = start_date 
date_end = end_date 
dt = 60 # !!!!!!!change back to 10
...
# for FORCES section
gravity_order = 8 #!!!!!!!!change back to 8
...
if predict_spec == 1:
    ...
    print "Predicting CYGNSS positions..."#/Users/cbv/cygnss/sift_local/code/spock/spock_sift -> spock_dev_again // /Users/cbv/cygnss/sift_local/code/spock/spec_sift_debug ->  spec_asph_debug

    
print path_mpirun + " -np 4 spock_sgp4 " + main_input_filename  #/Users/cbv/cygnss/sift_local/code/spock/spock_sift " + main_input_filename# !!!!!! used to be /Users/cbv/cygnss/sift_local/code/spock/spock_sift 072519 !!! used to be /Users/cbv/cygnss/sift_local/code/spock/spock_sift 081418
os.system(path_mpirun + " -np 4 spock_sgp4 " + main_input_filename ) #/Users/cbv/cygnss/sift_local/code/spock/spock_sift " + main_input_filename# !!!!!! used to be /Users/cbv/cygnss/sift_local/code/spock/spock_sift 072519 !!! used to be /Users/cbv/cygnss/sift_local/code/spock/spock_sift 081418 # can't redirect output at all (on windows it said "can't access file, busy with another process" or something like that and it made it crash. So either accept that the ouput is printed to the temrinal, or don't print anything with spock, spec and storm
#used to be (11-30-17): os.system(path_mpirun + " -np 4 /Users/cbv/cygnss/sift_local/code/spock/spock_sift_parallel_kalman_9state " + main_input_filename + " >> " + log_filename)
...
if predict_spec == 1:
    ...
    # New 07-25-19. Before, see 2 lines below these 2 lines
    print path_mpirun + " -np 4 spec " + main_input_filename + " -lon=0 -rot=0 -min"
    os.system(path_mpirun + " -np 4 spec " + main_input_filename + " -lon=0 -rot=0 -min")

    
    # # New 09-05-18. Before, see 2 lines below these 2 lines
    # print path_mpirun + " -np 4 /Users/cbv/cygnss/sift_local/code/spock/spec_sift_debug " + main_input_filename + " -lon=0 -rot=0 -min"
    # os.system(path_mpirun + " -np 4 /Users/cbv/cygnss/sift_local/code/spock/spec_sift_debug " + main_input_filename + " -lon=0 -rot=0 -min")

    # Until 09-05-18 below 2 lines
    # print path_mpirun + " -np 4 spec_dev_debug " + main_input_filename + " -lon=0 -rot=0 -min"
    # os.system(path_mpirun + " -np 4 spec_dev_debug " + main_input_filename + " -lon=0 -rot=0 -min")
