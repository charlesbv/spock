...
print path_mpirun + " -np 4 spock_web " + main_input_filename + " >> " + log_filename
os.system(path_mpirun + " -np 4 spock_web " + main_input_filename + " >> " + log_filename)
...
if predict_spec == 1:
    ...
    print path_mpirun + " -np 4 spec_web " + main_input_filename + " -lon=0 -rot=0 -min >> " + log_filename
    os.system(path_mpirun + " -np 4 spec_web " + main_input_filename + " -lon=0 -rot=0 -min >> " + log_filename)
    ...
    print path_mpirun + " -np 4 storm_web " + main_input_filename + " 0 >> " +  log_filename
    os.system(path_mpirun + " -np 4 storm_web " + main_input_filename + " 0 >> " +  log_filename)
