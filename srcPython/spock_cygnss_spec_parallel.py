...
print path_mpirun + " -np 4 spock " + main_input_filename 
os.system(path_mpirun + " -np 4 spock " + main_input_filename ) # can't redirect output at all (on windows it said "can't access file, busy with another process" or something like that and it made it crash. So either accept that the ouput is printed to the temrinal, or don't print anything with spock, spec and storm
...
if predict_spec == 1:
    ...
    print path_mpirun + " -np 4 storm " + main_input_filename + " 0"
    os.system(path_mpirun + " -np 4 storm " + main_input_filename + " 0")
