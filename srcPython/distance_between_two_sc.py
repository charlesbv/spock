...
dt_sat1 = input_variables[find_in_read_input_order_variables(order_input_variables, 'dt')]; nb_steps_sat1 = input_variables[find_in_read_input_order_variables(order_input_variables, 'nb_steps')];
...
date_start = datetime.strptime(var_out[0][0], "%Y/%m/%d %H:%M:%S.%f")
...
if same_spock_input_file == 1:
    ...
    dt_sat2 = input_variables[find_in_read_input_order_variables(order_input_variables, 'dt')]; nb_steps_sat2 = input_variables[find_in_read_input_order_variables(order_input_variables, 'nb_steps')];
else:
...
ax.plot(x_axis, y_axis[0:nb_steps:step_plot_in_index] * factor_on_y, linewidth = 2, color = 'k')#ax.plot(x_axis, y_axis[0:nb_steps:step_plot_in_index] * factor_on_y, linewidth = 2, color = 'k')
