...
spock_dir = "."
if show_spec == 0:
    os.system("spock_cygnss_spec_parallel.py " + start_date_str + " " + end_date_str)
else:
...
for isc in range(nb_sc):
    ...
    if show_spec == 0:
        ...
        date_spec_this_sc, lon_spec_this_sc, lat_spec_this_sc, gain_spec_this_sc, gps_spec_this_sc,  x_spec_useless, y_spec_useless, z_spec_useless = cygnss_read_spock_spec(filename_spec_spock)
