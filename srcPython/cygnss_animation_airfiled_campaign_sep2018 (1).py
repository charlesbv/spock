...
filename = sys.argv[1]#'toshare/20180910T000000_to_20180924T000000.txt' #20180910T000000_to_20180924T000000
...
icount = -1 #1484 # -1
for iii in np.arange(0,n,20):#np.arange(index_n_first_hours[0], index_n_first_hours[-1], dindex):
    #if date[iii] < datetime.strptime("2018-09-16T08:14:25", "%Y-%m-%dT%H:%M:%S"):    
    icount = icount + 1
    print date[iii]
