...
# To run it: 
# run report_coverage_ground_station.py main_input_filename
...
for isat in range(nb_satellites):
    ...
    filename_station_out = satellite_to_plot_path + 'coverage/report_coverage_all_stations_by_' + satellite_to_plot
...
if plot_results == 1:
    ...
    for isat in range(nb_satellites):
        ...
        for istation in range(nb_stations):
            ...
            if len(overflight_all_sat_all_station[isat][istation]) > 0:
