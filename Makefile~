ifdef COMPILER
	CC=${PATH_COMPILER} -static -DINLINE -Wall -g -std=gnu99 -O0 -Wextra -fdiagnostics-color=auto
...
clean:
	find  ${PATH_EXECUTABLE} -type f -maxdepth 1 -name spock -delete #rm -f  ${PATH_EXECUTABLE}/spock # ignore the warning with maxdepth (it does work)
	rm -f ./src/*.o
	rm -f ./src/mpi_fake/*.o
